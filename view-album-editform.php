      ...
      <div class="modal-body">
        <form method="post" action="">
           <div class="mb-3">
            ...
            <div class="mb-3">
             <label for="alYear<?php echo $album['album_id']; ?>" class="form-label">Album Release Year</label>
             <input type="text" class="form-control" id="alYear<?php echo $album['album_id']; ?>" name="alYear" value ="<?php echo $album['release_year']; ?>">
           </div>
