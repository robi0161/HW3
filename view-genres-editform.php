    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
           ...
           <div class="mb-3">
             <label for="gDesc<?php echo $genre['genre_id']; ?>" class="form-label">Genre Description</label>
             <input type="text" class="form-control" id="gDesc<?php echo $genre['genre_id']; ?>" name="gDesc" value ="<?php echo $genre['genre_description']; ?>">
           </div>
